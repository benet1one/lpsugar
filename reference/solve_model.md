...
Find the optimum of an Optimization Model created with
[`make_model()`](https://benet1one.github.io/lpsugar/reference/make_model.md)
or [`ROI::OP()`](https://rdrr.io/pkg/ROI/man/OP.html). Used internally
in
...
- model:
  ...
  An `OP` object created with
  [`make_model()`](https://benet1one.github.io/lpsugar/reference/make_model.md)
  or [`ROI::OP()`](https://rdrr.io/pkg/ROI/man/OP.html).
